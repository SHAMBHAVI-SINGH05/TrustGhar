...
import { ShieldCheck, Bell, LogOut, Download, Radio, ArrowLeft, CheckCircle, AlertTriangle, XCircle, GitBranch, Lock } from 'lucide-react'
      ...
      <div className="max-w-5xl mx-auto px-8 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-stone-400 text-sm mt-1">Prestige Towers, Whitefield, Bangalore — generated 23 Jun</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-6 items-stretch">
          ...
          <div className="flex flex-col gap-5">
            ...
            <button className="flex items-center justify-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white py-3 rounded-xl font-semibold text-sm transition-all shadow-lg shadow-indigo-200">
