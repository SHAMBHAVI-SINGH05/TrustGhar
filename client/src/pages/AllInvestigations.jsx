...
import { ShieldCheck, Bell, LogOut, MapPin, ArrowLeft, CheckCircle, Clock, XCircle, Activity } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen" style={{ background: '#f5ede0' }}>
      ...
      <div className="max-w-6xl mx-auto px-8 py-10">
        ...
        <div className="mb-6">
          <h1 className="text-stone-900 text-2xl font-extrabold tracking-tight">All Investigations</h1>
          <p className="text-stone-400 text-sm mt-1">Every property investigation you've run on TrustGhar</p>
        </div>

        <div className="bg-white rounded-2xl shadow-sm border border-stone-100 overflow-hidden">
          <div className="flex items-center gap-2 px-6 py-4 border-b border-stone-50">
            <Activity className="w-4 h-4 text-indigo-500" />
            <h2 className="text-stone-900 font-bold text-sm">{investigations.length} Investigation{investigations.length !== 1 ? 's' : ''}</h2>
          </div>
